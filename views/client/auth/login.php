                ...
                <div class="col-xl-6 col-lg-8">
                    <div class="tp-login-wrapper">
                        <div class="tp-login-top text-center mb-30">
                            ...
                            <p>Bạn chưa có tài khoản?<span><a href="?act=register">Tạo một tài khoản miễn phí</a></span></p>
                        </div>
                        <div class="tp-login-option">
                            ...
                            <form action="?act=login" method="post">
                                <div class="tp-login-input-wrapper">
                                    ...
                                    <div class="tp-login-input-box">
                                        <div class="tp-login-input">
                                            <input id="tp_password" name="password" type="password" placeholder="Nhập mật khẩu">
                                        </div>
                                ...
                                <div class="tp-login-bottom">
                                    <button type="submit" name="login" class="tp-login-btn w-100">Đăng nhập</button>
                                </div>
                            </form>
                        </div>
                    </div>
