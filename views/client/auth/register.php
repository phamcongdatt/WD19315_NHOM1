                ...
                <div class="col-xl-6 col-lg-8">
                    <div class="tp-login-wrapper">
                        <div class="tp-login-top text-center mb-30">
                            <h3 class="tp-login-title">Đăng ký Shofy.</h3>
                            <p>Đã có tài khoản? <span><a href="?act=login">Đăng nhập</a></span></p>
                        </div>
                        <div class="tp-login-option">
                            ...
                            <form id="signupForm" action="?act=register" method="post">
                                <div class="tp-login-input-wrapper">
                                    <div class="tp-login-input-box">
                                        <div class="tp-login-input">
                                            <input id="name" name="name" type="text" placeholder="Nhập tên của bạn...">
                                        </div>
                                    ...
                                    <div class="tp-login-input-box">
                                        <div class="tp-login-input">
                                            <input id="tp_password" type="password" name="password" placeholder="Nhập mật khẩu">
                                        </div>
                                ...
                                <div class="tp-login-suggetions d-sm-flex align-items-center justify-content-between mb-20">
                                    <div class="tp-login-remeber">
                                        ...
                                        <label for="remeber">Tôi chấp nhận các điều khoản của Chính sách dịch vụ và quyền riêng tư.</label>
                                    </div>
                                </div>
                                <div class="tp-login-bottom">
                                    <button name="register" class="tp-login-btn w-100">Đăng ký</button>
                                </div>
                            </form>
                        </div>
                    </div>
