                                ...
                                <div class="nav nav-tabs flex-sm-column " id="productDetailsNavThumb" role="tablist">
                                    <?php foreach ($productDetail['galleries'] as $key => $gallery): ?>
                                        <button class="nav-link <?= $key === 0 ? 'active' : '' ?>"
                                            ...
                                            data-bs-target="#nav-<?= $key + 1 ?>" type="button" role="tab"
                                            aria-controls="nav-<?= $key + 1 ?>"
                            ...
                            <div class="tab-content m-img" id="productDetailsNavContent">
                                <?php foreach ($productDetail['galleries'] as $key => $gallery): ?>
                                    <div class="tab-pane fade show <?= $key === 0 ? 'active' : '' ?>"
                                        id="nav-<?= $key + 1 ?>" role="tabpanel" aria-labelledby="nav-<?= $key + 1 ?>-tab"
                                        tabindex="0">
                                        <div class="tp-product-details-nav-main-thumb">
                                            <img src="./images/product_gallery/<?= $gallery ?>" width="670px" alt="">
                                        </div>
                                    </div>
                                <?php endforeach; ?>
                            </div>
                    ...
                    <div class="col-xl-5 col-lg-6">
                        <form action="?act=addToCart-byNow" method="post">
                            <div class="tp-product-details-wrapper">
                                ...
                                <p><?= $productDetail['product_description'] ?>...<span>Xem thêm</span></p>

                                <!-- price -->
                                <div class="tp-product-details-price-wrapper mb-20">
                                    <span
                                        class="tp-product-details-price old-price price-variants"><?= number_format($productDetail['product_price'] * 1000, 0, ',', '.') ?>
                                        VNĐ</span>
                                    <span
                                        class="tp-product-details-price new-price sale-price-variants"><?= number_format($productDetail['product_sale_price'] * 1000, 0, ',', '.') ?>
                                        VNĐ</span>
                                    ...
                                    <div class="tp-product-details-variation-item">
                                        ...
                                        <div class="tp-product-details-variation-list">
                                            <?php foreach ($productDetail['variants'] as $variant): ?>
                                                <button type="button" class="color tp-color-variation-btn btn-color"
                                                    data-color="<?= $variant['variant_color_code'] ?>">
                                                    <span data-bg-color="<?= $variant['variant_color_code'] ?>"
                                                        class="border"></span>
                                                    <span
                                                        class="tp-color-variation-tootltip"><?= $variant['variant_color_name'] ?></span>
                                                </button>
                                            <?php endforeach; ?>
                                        </div>
                                    </div>
                                    <!-- single item -->
                                    <div class="tp-product-details-variation-item">Dung lượng: </h4>
                                        <div class="tp-product-details-variation-list">
                                            <?php foreach ($productDetail['variants'] as $variant): ?>
                                                <button type="button" class=" tp-size-variation-btn btn-size"
                                                    data-size="<?= $variant['variant_size_name'] ?>">
                                ...
                                <div class="tp-product-details-action-wrapper">
                                    ...
                                    <div class="tp-product-details-action-item-wrapper d-flex align-items-center">
                                        ...
                                        <form action="your_php_file.php?act=addToCart-byNow" method="post">
                                    ...
                                    <button class="tp-product-details-buy-now-btn w-100" name="buy_now">Mua
                                        ngay</button>
                                </div>
                                            ...
                                            <div class="col-xl-10">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="tp-product-details-desc-thumb">
                                                                <img src="client/assets/img/product/details/desc/product-details-desc-1.jpg"
                                                                    alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="tp-product-details-desc-item  pb-75">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-7">
                                                            <div class="tp-product-details-desc-thumb">
                                                                <img src="client/assets/img/product/details/desc/product-details-desc-2.jpg"
                                                                    alt="">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-12">
                                                            <div
                                                                ...
                                                                <img src="client/assets/img/product/details/desc/product-details-desc-3.jpg"
                                                                    alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="tp-product-details-review-list pr-110">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="tp-product-details-review-avater-thumb">
                                                                <a href="#">
                                                                    <img src="client/assets/img/users/user-3.jpg"
                                                                        alt="">
                                                                </a>
                                                            </div>
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="tp-product-details-review-avater-thumb">
                                                                <a href="#">
                                                                    <img src="client/assets/img/users/user-2.jpg"
                                                                        alt="">
                                                                </a>
                                                            </div>
                                                            <div class="tp-product-details-review-avater-content">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // lấy và chuyển dữ liệu của php sang javaScript
        ...
        colorButtons.forEach(button => {
            button.addEventListener('click', function () {
                ...
                updateSize(); //cập nhật dung lượng
        ...
        function updateColor() {
            colorButtons.forEach(button => {
                ...
                // kiểm tra dung lượng đã chọn có màu này không
