                            ...
                            <div class="tp-shop-widget-content">
                                <div class="tp-shop-widget-categories">
                                    <ul>
                                        ...
                                        <li><a href="#">Oppo<span>22</span></a></li>
                                        <li><a href="#">Vivo<span>17</span></a></li>
                                            ...
                                            <div class="col-xl-3 col-lg-3 col-sm-6">
                                                <div class="tp-product-item p-relative transition-3 mb-25">
                                                    <div class="tp-product-thumb p-relative fix m-img">
                                                        <a href="?act=product-detail&slug=<?= $product['product_slug'] ?>">
                                                    ...
                                                    <div class="tp-product-content">
                                                        <div class="tp-product-category">
                                                            <a href="shop.html"><?=$product['category_name']?></a>
                                                        </div>
                                                        ...
                                                        <div class="tp-product-price-wrapper">
                                                            <span class="tp-product-price old-price"><?=number_format($product['product_price'] * 1000, 0, ',' , '.')?> VNĐ</span>
                                                            <span class="tp-product-price new-price"><?=number_format($product['product_sale_price'] * 1000, 0, ',' , '.')?> VNĐ</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
