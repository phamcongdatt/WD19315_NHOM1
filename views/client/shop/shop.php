                        ...
                        <div class="tp-shop-widget mb-50">
                            ...
                            <div class="tp-shop-widget-content">
                                <div class="tp-shop-widget-categories">
                                    <ul>
                                        <li><a href="?act=shop&category=<?= urlencode('iPhone') ?>">iPhone<span>10</span></a></li>
                                        <li><a href="?act=shop&category=<?= urlencode('Samsung') ?>">Samsung<span>18</span></a></li>
                                        <li><a href="?act=shop&category=<?= urlencode('Oppo') ?>">Oppo<span>22</span></a></li>
                                        <li><a href="?act=shop&category=<?= urlencode('Vivo') ?>">Vivo<span>17</span></a></li>
                                        <li><a href="?act=shop&category=<?= urlencode('Xiaomi') ?>">Xiaomi<span>22</span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xl-9 col-lg-8">
                    <div class="tp-shop-main-wrapper">
                                    ...
                                    <div class="tp-shop-top-right d-sm-flex align-items-center justify-content-xl-end">
                                        <!-- <div class="tp-shop-top-select">
                                            <select>
                                                ...
                                                <option>Mới được thêm vào</option>
                                                <option>Đang giảm giá</option>
                                            </select>
                                        </div> -->
                                        <div class="tp-shop-top-filter">
                                            <button type="button" class="tp-filter-btn filter-open-btn" data-bs-toggle="modal" data-bs-target="#filterModal">
                                                <span>
                                                    <svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <form id="filterForm" method="GET" action="">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" id="category" name="category">
                                                    ...
                                                    <option value="iPhone" <?php echo (isset($_GET['category']) && $_GET['category'] == 'iPhone') ? 'selected' : ''; ?>>iPhone</option>
                                                    <option value="Samsung" <?php echo (isset($_GET['category']) && $_GET['category'] == 'Samsung') ? 'selected' : ''; ?>>Samsung</option>
                                                    <option value="Oppo" <?php echo (isset($_GET['category']) && $_GET['category'] == 'Oppo') ? 'selected' : ''; ?>>Oppo</option>
                                                    <option value="Vivo" <?php echo (isset($_GET['category']) && $_GET['category'] == 'Vivo') ? 'selected' : ''; ?>>Vivo</option>
                                                    <option value="Xiaomi" <?php echo (isset($_GET['category']) && $_GET['category'] == 'Xiaomi') ? 'selected' : ''; ?>>Xiaomi</option>
                                                </select>
                                            </div>
                                            <!-- Lọc theo giá -->
                                            <div class="mb-3">
                                                <label for="price_range" class="form-label">Khoảng giá (VNĐ)</label>
                                                <input type="number" class="form-control" id="min_price" name="min_price" placeholder="Giá tối thiểu" value="<?php echo isset($_GET['min_price']) ? $_GET['min_price'] : ''; ?>">
                                                <input type="number" class="form-control mt-2" id="max_price" name="max_price" placeholder="Giá tối đa" value="<?php echo isset($_GET['max_price']) ? $_GET['max_price'] : ''; ?>">
                                            </div>
                                        </form>
                                    </div>
                        ...
                        <div class="tp-shop-items-wrapper tp-shop-item-primary">
                            ...
                            <?php endif; ?>
                            <?php if (!empty($_SESSION['keyword'])): ?>
                                <p>Kết quả tìm kiếm với từ khóa: <?php echo $_SESSION['keyword']; ?></p>
                            <?php endif; ?>
                                            ...
                                            <div class="col-xl-3 col-lg-3 col-sm-6">
                                                <div class="tp-product-item p-relative transition-3 mb-25">
                                                    <div class="tp-product-thumb p-relative fix m-img">
                                                        <a href="?act=product-detail&slug=<?= urlencode($product['product_slug']) ?>">
                                                    ...
                                                    <div class="tp-product-content">
                                                        <div class="tp-product-category">
                                                            <a href="?act=shop&category=<?= urlencode($product['category_name']) ?>"><?= $product['category_name'] ?></a>
                                                        </div>
                                                        <h3 class="tp-product-title">
                                                            <a href="?act=product-detail&slug=<?= urlencode($product['product_slug']) ?>"><?= $product['product_name'] ?></a>
                                                        </h3>
                                                        ...
                                                        <div class="tp-product-price-wrapper">
                                                            <span class="tp-product-price old-price"><?= number_format($product['product_price'], 0, ',', '.') ?> VNĐ</span>
                                                            <span class="tp-product-price new-price"><?= number_format($product['product_sale_price'], 0, ',', '.') ?> VNĐ</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
