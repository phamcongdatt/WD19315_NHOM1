        ...
        <div class="container">
            <div class="profile__inner p-relative">
                <div class="profile__shape">
                    <img class="profile__shape-1" src="client/assets/img/login/laptop.png" alt="">
                    <img class="profile__shape-2" src="client/assets/img/login/man.png" alt="">
                    <img class="profile__shape-3" src="client/assets/img/login/shape-1.png" alt="">
                    <img class="profile__shape-4" src="client/assets/img/login/shape-2.png" alt="">
                    <img class="profile__shape-5" src="client/assets/img/login/shape-3.png" alt="">
                    <img class="profile__shape-6" src="client/assets/img/login/shape-4.png" alt="">
                </div>
                <div class="row">
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-md-6">
                                                    <div class="profile__main-inner d-flex flex-wrap align-items-center">
                                                        <div class="profile__main-thumb">
                                                            <img src="client/assets/img/users/user-10.jpg" alt="">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="profile__main-logout text-sm-end">
                                                        <a href="login.html" class="tp-logout-btn">Đăng xuất</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <form action="?act=update-profile" method="POST">
                                                <div class="row">
                                                    <div class="col-xxl-6 col-md-6">
                                                        <div class="profile__input-box">
                                                            <div class="profile__input">
                                                                ...
                                                                </div><?php if (isset($_SESSION['errors']['name'])): ?>
                                                    ...
                                                    <div class="col-xxl-6 col-md-6">
                                                        <div class="profile__input-box">
                                                            <div class="profile__input">
                                                                ...
                                                                </div><?php if (isset($_SESSION['errors']['email'])): ?>
                                                    ...
                                                    <div class="col-xxl-6 col-md-6">
                                                        <div class="profile__input-box">
                                                            <div class="profile__input">
                                                                <input type="text" placeholder="Vui lòng nhập số điện thoại của bạn" name="phone" value="<?=$_SESSION['user']['phone']?>">
                                                                <span>
                                                                ...
                                                                </div><?php if (isset($_SESSION['errors']['phone'])): ?>
                                                    ...
                                                    <div class="col-xxl-6 col-md-6">
                                                        <div class="profile__input-box">
                                                            ...
                                                            </div><?php if (isset($_SESSION['errors']['gender'])): ?>
                                                    ...
                                                    <div class="col-xxl-12">
                                                        <div class="profile__input-box">
                                                            <div class="profile__input">
                                                                <input type="text" placeholder="Vui lòng nhập địa chỉ" name="address" value="<?= $_SESSION['user']['address'] ?>">
                                                                <span>
                                                            ...
                                                            </div><?php if (isset($_SESSION['errors']['address'])): ?>
                                                ...
                                                <div class="col-xxl-12">
                                                    <div class="profile__input-box">
                                                        <div class="profile__input">
                                                            <textarea placeholder="Enter your bio">Xin chào, đây là tiểu sử của tôi...</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-12">
