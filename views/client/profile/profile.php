        ...
        <div class="container">
            <div class="profile__inner p-relative">
                <div class="profile__shape">
                    <img class="profile__shape-1" src="public/client/assets/img/login/laptop.png" alt="">
                    <img class="profile__shape-2" src="public/client/assets/img/login/man.png" alt="">
                    <img class="profile__shape-3" src="public/client/assets/img/login/shape-1.png" alt="">
                    <img class="profile__shape-4" src="public/client/assets/img/login/shape-2.png" alt="">
                    <img class="profile__shape-5" src="public/client/assets/img/login/shape-3.png" alt="">
                    <img class="profile__shape-6" src="public/client/assets/img/login/shape-4.png" alt="">
                </div>
                <div class="row">
                        ...
                        <div class="profile__tab mr-40">
                            <nav>
                                <div class="nav nav-tabs tp-tab-menu flex-column" id="profile-tab" role="tablist">
                                    <button class="nav-link active" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="true"><span><i class="fa-regular fa-user-pen"></i></span>Hồ sơ</button>
                                    ...
                                    <button class="nav-link" id="nav-notification-tab" data-bs-toggle="tab" data-bs-target="#nav-notification" type="button" role="tab" aria-controls="nav-notification" aria-selected="false"><span><i class="fa-regular fa-bell"></i></span>Thông báo</button>
                            ...
                            <div class="tab-content" id="profile-tabContent">
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-md-6">
                                                    <div class="profile__main-inner d-flex flex-wrap align-items-center">
                                                        <div class="profile__main-thumb">
                                                            <img src="public/client/assets/img/users/user-10.jpg" alt="">
                                                        ...
                                                        <div class="profile__main-content">
                                                            <h4 class="profile__main-title">Xin chào <?= htmlspecialchars($_SESSION['user']['name'] ?? '') ?>!</h4>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="profile__main-logout text-sm-end">
                                                        <a href="index.php?act=logout" class="tp-logout-btn">Đăng xuất</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row gx-3">
                                                <div class="col-md-3 col-sm-6">
                                                    <div class="profile__main-info-item">
                                                        ...
                                                        <h4 class="profile__main-info-title">Tải xuống</h4>
                                                    </div>
                                                </div>
                                                <div class="col-md-3 col-sm-6">
                                                    <div class="profile__main-info-item">
                                                        ...
                                                        <h4 class="profile__main-info-title">Đơn đặt hàng</h4>
                                                    </div>
                                                </div>
                                                <div class="col-md-3 col-sm-6">
                                                    <div class="profile__main-info-item">
                                                        ...
                                                        <h4 class="profile__main-info-title">Danh sách yêu thích</h4>
                                                    </div>
                                                </div>
                                                <div class="col-md-3 col-sm-6">
                                                    <div class="profile__main-info-item">
                                            ...
                                            <form action="index.php?act=update-profile" method="POST">
                                                ...
                                                <div class="row">
                                                    <div class="col-xxl-6 col-md-6">
                                                        <div class="profile__input-box">
                                                            <div class="profile__input">
                                                                <input type="text" placeholder="Enter your username" name="name" value="<?= htmlspecialchars($_SESSION['user']['name'] ?? '') ?>">
                                                                <span>
                                                    ...
                                                    <div class="col-xxl-6 col-md-6">
                                                        <div class="profile__input-box">
                                                            <div class="profile__input">
                                                                <input type="email" placeholder="Enter your email" name="email" value="<?= htmlspecialchars($_SESSION['user']['email'] ?? '') ?>">
                                                                <span>
                                                    ...
                                                    <div class="col-xxl-6 col-md-6">
                                                        <div class="profile__input-box">
                                                            <div class="profile__input">
                                                                <input type="text" placeholder="Vui lòng nhập số điện thoại của bạn" name="phone" value="<?= htmlspecialchars($_SESSION['user']['phone'] ?? '') ?>">
                                                                <span>
                                                            ...
                                                            <?php if (isset($_SESSION['errors']['phone'])): ?>
                                                                <p class="text-danger"><?= htmlspecialchars($_SESSION['errors']['phone']) ?></p>
                                                            <?php endif; ?>
                                                        </div>
                                                    </div>
                                                    <div class="col-xxl-6 col-md-6">
                                                        <div class="profile__input-box">
                                                            <div class="profile__input">
                                                                <select name="gender">
                                                                    <option value="Nam" <?= ($_SESSION['user']['gender'] ?? '') == 'Nam' ? 'selected' : '' ?>>Nam giới</option>
                                                                    <option value="Nu" <?= ($_SESSION['user']['gender'] ?? '') == 'Nu' ? 'selected' : '' ?>>Nữ giới</option>
                                                                    <option value="Khac" <?= ($_SESSION['user']['gender'] ?? '') == 'Khac' ? 'selected' : '' ?>>Khác</option>
                                                                </select>
                                                            </div>
                                                            <?php if (isset($_SESSION['errors']['gender'])): ?>
                                                                <p class="text-danger"><?= htmlspecialchars($_SESSION['errors']['gender']) ?></p>
                                                            <?php endif; ?>
                                                        </div>
                                                    </div>
                                                    <div class="col-xxl-12">
                                                        <div class="profile__input-box">
                                                            <div class="profile__input">
                                                                <input type="text" placeholder="Vui lòng nhập địa chỉ" name="address" value="<?= htmlspecialchars($_SESSION['user']['address'] ?? '') ?>">
                                                                <span>
                                                            ...
                                                            <?php if (isset($_SESSION['errors']['address'])): ?>
                                                                <p class="text-danger"><?= htmlspecialchars($_SESSION['errors']['address']) ?></p>
                                                            <?php endif; ?>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-12">
                                                    <div class="profile__btn">
                                                        <button type="submit" name="update-profile" class="tp-btn">Cập nhật hồ sơ</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                                ...
                                <div class="tab-pane fade" id="nav-password" role="tabpanel" aria-labelledby="nav-password-tab">
                                    <div class="profile__password">
                                        <h3 class="profile__password-title">Đổi mật khẩu</h3>
                                        <form action="index.php?act=update-password" method="POST">
                                            <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($_SESSION['csrf_token']) ?>">
                                            <div class="row">
                                                <div class="col-xxl-12">
                                                    <div class="tp-profile-input-box">
                                                        <div class="tp-profile-input">
                                                            <input name="current_password" id="current_password" type="password" placeholder="Mật khẩu cũ">
                                                        </div>
                                                        ...
                                                        <?php if (isset($_SESSION['errors']['current_password'])): ?>
                                                            <p class="text-danger"><?= htmlspecialchars($_SESSION['errors']['current_password']) ?></p>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-6 col-md-6">
                                                    <div class="tp-profile-input-box">
                                                        <div class="tp-profile-input">
                                                            <input name="new_password" id="new_password" type="password" placeholder="Mật khẩu mới">
                                                        </div>
                                                        <div class="tp-profile-input-title">
                                                            <label for="new_password">Mật khẩu mới</label>
                                                        </div>
                                                        <?php if (isset($_SESSION['errors']['new_password'])): ?>
                                                            <p class="text-danger"><?= htmlspecialchars($_SESSION['errors']['new_password']) ?></p>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-6 col-md-6">
                                                    <div class="tp-profile-input-box">
                                                        <div class="tp-profile-input">
                                                            <input name="confirm_password" id="confirm_password" type="password" placeholder="Xác nhận mật khẩu">
                                                        </div>
                                                        <div class="tp-profile-input-title">
                                                            <label for="confirm_password">Xác nhận mật khẩu</label>
                                                        </div>
                                                        <?php if (isset($_SESSION['errors']['confirm_password'])): ?>
                                                            <p class="text-danger"><?= htmlspecialchars($_SESSION['errors']['confirm_password']) ?></p>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-6 col-md-6">
                                                    <div class="profile__btn">
                                                        <button type="submit" name="update-password" class="tp-btn">Cập nhật</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                                            ...
                                            <div class="col-md-6">
                                                <div class="profile__address-item d-sm-flex align-items-start">
                                                    ...
                                                    <div class="profile__address-content">
                                                        <h3 class="profile__address-title">Địa chỉ thanh toán</h3>
                                                        <p><span>Đường:</span>3576 Glen Street</p>
                                                        <p><span>Thành phố:</span>Summer Shade</p>
                                                        <p><span>Tiểu bang/tỉnh/khu vực:</span>Kentucky</p>
                                                        <p><span>Số điện thoại:</span>270-428-8378</p>
                                                        <p><span>Zip code:</span>42166</p>
                                                        <p><span>Country calling code:</span> +1</p>
                                                        <p><span>Quốc gia:</span>United States</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                ...
                                <div class="tab-pane fade" id="nav-notification" role="tabpanel" aria-labelledby="nav-notification-tab">
                                    <div class="profile__notification">
                                        <div class="profile__notification-top mb-30">
                                            <h3 class="profile__notification-title">Cài đặt hoạt động của tôi</h3>
                                            <p>Luôn cập nhật thông báo về hoạt động liên quan đến bạn bao gồm đề cập, tin nhắn,
                                                trả lời giá thầu của bạn, mặt hàng mới, cập nhật bán hàng và quản trị</p>
                                        </div>
