...
<!-- Mirrored from techzaa.in/larkon/admin/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Nov 2024 13:14:34 GMT -->
                        ...
                        <div class="dropdown topbar-item">
                            ...
                            <div class="dropdown-menu py-0 dropdown-lg dropdown-menu-end" aria-labelledby="page-header-notifications-dropdown">
                                ...
                                <div data-simplebar style="max-height: 280px;">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item py-3 border-bottom">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                <p class="mb-0 fw-semibold text-wrap">Bạn đã nhận được<b>20</b> tin nhắn mới trong
                                                cuộc hội thoại</p>
                                            </div>
                                        </div>
                                    </a>
                                ...
                                <div class="text-center py-3">
                                    <a href="javascript:void(0);" class="btn btn-primary btn-sm">Xem tất cả thông báo <i class="bx bx-right-arrow-alt ms-1"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="dropdown topbar-item">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item" href="pages-pricing.html">
                                    <i class="bx bx-wallet text-muted fs-18 align-middle me-1"></i><span class="align-middle">Định giá</span>
                                </a>
                                <a class="dropdown-item" href="pages-faqs.html">
                                    <i class="bx bx-help-circle text-muted fs-18 align-middle me-1"></i><span class="align-middle">Hỗ trợ</span>
                                </a>
        ...
        <div>
            <div class="offcanvas offcanvas-end border-0" tabindex="-1" id="theme-activity-offcanvas" style="max-width: 450px; width: 100%;">
                <div class="d-flex align-items-center bg-primary p-3 offcanvas-header">
                    <h5 class="text-white m-0 fw-semibold">Luồng hoạt động</h5>
                ...
                <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <div class="collapse" id="sidebarProducts">
                            <ul class="nav sub-navbar-nav">
                                <li class="sub-nav-item">
                                    <a class="sub-nav-link" href="index.php?act=product">Danh sách</a>
                                </li>
                                <li class="sub-nav-item">
                                    <a class="sub-nav-link" href="index.php?act=product-create">Thêm sản phẩm</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="sidebarCategory">
                            <ul class="nav sub-navbar-nav">
                                <li class="sub-nav-item">
                                    <a class="sub-nav-link" href="index.php?act=category">Danh sách</a>
                                </li>
                                <li class="sub-nav-item">
                                    <a class="sub-nav-link" href="index.php?act=category-create">Thêm danh mục</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="sidebarOrders">
                            <ul class="nav sub-navbar-nav">
                                ...
                                <li class="sub-nav-item">
                                    <a class="sub-nav-link" href="orders-list.html">Danh sách</a>
                                </li>
                                <li class="sub-nav-item">
                                    <a class="sub-nav-link" href="order-detail.html">Chi tiết</a>
                                </li>
                                <li class="sub-nav-item">
                                    <a class="sub-nav-link" href="order-cart.html">Giỏ hàng</a>
                                </li>
                                <li class="sub-nav-item">
                                    <a class="sub-nav-link" href="order-checkout.html">Kiểm tra</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="sidebarCoupons">
                            <ul class="nav sub-navbar-nav">
                                <li class="sub-nav-item">
                                    <a class="sub-nav-link" href="?act=coupon">Danh sách</a>
                                </li>
                                <li class="sub-nav-item">
                                    <a class="sub-nav-link" href="?act=coupon-create">Thêm mã giảm giá</a>
                                </li>
                            </ul>
                        </div>
                    </li> 
